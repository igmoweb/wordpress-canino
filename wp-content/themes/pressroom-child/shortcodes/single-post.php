	...
	if((int)$show_post_author_box)
	{
		...
		$output .= '<div class="author_box animated_element">
			...
			<div id="at4-share" class="addthis_32x32_style atss at4-show">
				...
				<a class="at4-share-btn at-svc-email" href="#"><span class=" at4-icon aticon-email" title="Correo">Correo</span></a>
				<a class="at4-share-btn at-svc-twitter" href="#"><span class=" at4-icon aticon-twitter" title="Twitter">Twitter</span></a>
				<a class="at4-share-btn at-svc-print" href="#"><span class=" at4-icon aticon-print" title="Imprimir">Imprimir</span></a>
				<a class="at4-share-btn at-svc-favorites" href="#"><span class=" at4-icon aticon-favorites" title="Favoritos">Favoritos</span></a>
				<a class="at4-share-btn at-svc-compact" href="#"><span class=" at4-icon aticon-compact" title="Más...">Más...</span></a>
			</div>
		</div>';
	}
	if($post_format=="image")
