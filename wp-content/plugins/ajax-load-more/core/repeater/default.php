...
foreach($categories as $category) {
    if($cat_i != 0) { echo ", "; } ?>
	<a class="category-<?php echo $category->term_id;?>" href="http://dev.caninomag.es/category/<?php echo $category->slug;?>/" title="View all posts filed under <?php echo $category->name;?>"><?php echo $category->name;?></a>
<?php $cat_i++;} ?>
</li>
