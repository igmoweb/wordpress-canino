<?php
/*
Plugin Name: Category Posts Widget (Ignacio)
Plugin URI:
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id("offset"); ?>">
				<?php _e( 'Offset' ); ?>:
				<input class="widefat" id="<?php echo $this->get_field_id("offset"); ?>" name="<?php echo $this->get_field_name("offset"); ?>" type="number" value="<?php echo esc_attr($instance["offset"]); ?>" />
			</label>
		</p>
		<p>
